...
1.  **Get your Key:** You'll need a free API key from Google Gemini. Get it [here](https://aistudio.google.com/app/apikey).
...
**برای استفاده عادی:**
۱. به بخش [**Releases**](../../releases) (انتشارها) در گیت‌هاب بروید.
...
۱. **دریافت کلید:** ابتدا یک کلید API رایگان از گوگل جمنای دریافت کنید. [لینک دریافت](https://aistudio.google.com/app/apikey)
